...
<body>
    <div id="viewport">
    	...
    	<div class="top">
            <img src="./img/home.png" class="home-btn" alt="" onclick="firstSlide()"><p>Project</p>
    	</div>
        ...
        <div class="slider">
            ...
            <div class="slide">
            	...
            	<div class="slide-content">
            		<p class="small-caption">Текст<br>сообщения</p>
            		<div class="scrollbar">
            	...
            	<img src="./img/slide_2/bg_2.png" alt="">
            </div>
            <div class="slide">
